export const translations = {
  ua: {
    ...
    hero_btn_programs: "Наші програми",
    ...
    about_card2_desc: "Конференції, освітні школи, культурні заходи",
    about_card3_title: "Допомагаємо",
    about_card3_desc: "Пошук опонентів, заявки на <strong>гранти</strong>",
    about_card4_title: "Мотивуємо",
    about_card4_desc: "Конкурси з цінними призами та <strong>грошовими винагородами</strong>",
    ...
    news_title: "Новини",
    news_btn_all: "Всі новини",
    
    team_label: "Команда",
    team_title: "Склад Ради",
    team_join: 'Хочете долучитися? Пишіть на <a href="mailto:rmv.khoda@gmail.com">rmv.khoda@gmail.com</a>',
    team_btn_all: "Повний склад Ради",
    
    partners_label: "Співпраця",
    partners_title: "Партнери Ради",
    partner_1: "МОН України",
    partner_2: "ОДА",
    partner_3: "КНУ ім. Шевченка",
    partner_4: "НАН України",
    
    docs_label: "Документація",
    docs_title: "Звіти та документи",
    doc1_title: "Статут організації",
    doc2_title: "Звіт за 2026 рік",
    doc2_desc: "PDF · Річний",
    doc3_title: "Протоколи засідань",
    doc4_title: "Історія Ради",
    doc4_desc: "PDF · Архів",
    
    contacts_label: "Зв'язок",
    contacts_title: "Контакти",
    contacts_desc: "Маєте питання або хочете долучитись до нашої команди? Будемо раді почути вас.",
    contacts_address: "Адреса",
    contacts_address_text: "61022, м. Харків Держпром, 9 під’їзд, 4 поверх",
    ...
    school_header_title: "Школа молодого лідера",
    school_header_desc: "Інтенсивна програма розвитку soft-skills, управління проєктами та комунікацій для науковців",
    school_intro_title: "Що таке Школа лідера?",
    school_intro_desc: "Це унікальний освітній простір, де молоді науковці вчаться перетворювати свої ідеї на успішні проєкти. Ми об'єднуємо найкращих експертів з менеджменту, фандрейзингу та ораторського мистецтва, щоб дати вам практичні інструменти для кар'єрного стрибка.",
    school_stat1_num: "5",
    school_stat1_label: "Тижнів інтенсиву",
    school_stat2_num: "12",
    school_stat2_label: "Експертів-практиків",
    school_stat3_num: "100+",
    school_stat3_label: "Випускників",
    school_curriculum_title: "Програма курсу",
    school_mod1_tag: "Soft Skills",
    school_mod1_title: "Емоційний інтелект та Лідерство",
    school_mod1_desc: "Як будувати довіру в команді дослідників, вирішувати конфлікти та мотивувати колег на результат.",
    school_mod2_tag: "Менеджмент",
    school_mod2_title: "Управління науковими проєктами",
    school_mod2_desc: "Основи Agile та Scrum у науці. Планування бюджету, ресурсів та тайм-менеджмент.",
    school_mod3_tag: "Фандрейзинг",
    school_mod3_title: "Грантовий райтинг",
    school_mod3_desc: "Як правильно написати заявку на грант, щоб отримати фінансування від європейських фондів.",
    school_mod4_tag: "PR та Медіа",
    school_mod4_title: "Наукова комунікація",
    school_mod4_desc: "Презентація результатів досліджень для бізнесу та ЗМІ. Основи сторітеллінгу та публічних виступів.",
    school_cta_title: "Відкрито набір!",
    ...
    team_header_title: "Склад Ради молодих вчених",
    team_header_desc: "Об'єднуємо найкращих молодих науковців для розвитку науки та інновацій",
  ...
  en: {
    ...
    hero_btn_programs: "Our programs",
    ...
    about_card2_desc: "Conferences, educational schools, cultural events",
    about_card3_title: "We assist",
    about_card3_desc: "Finding opponents, applying for <strong>grants</strong>",
    about_card4_title: "We motivate",
    about_card4_desc: "Competitions with valuable prizes and <strong>cash rewards</strong>",
    ...
    team_label: "Team",
    team_title: "Council Members",
    team_join: 'Want to join? Write to <a href="mailto:rmv.khoda@gmail.com">rmv.khoda@gmail.com</a>',
    team_btn_all: "Full Council Members",
    
    partners_label: "Cooperation",
    partners_title: "Council Partners",
    partner_1: "MES of Ukraine",
    partner_2: "Regional State Administration",
    partner_3: "Taras Shevchenko National University",
    partner_4: "NAS of Ukraine",
    
    docs_label: "Documentation",
    docs_title: "Reports and documents",
    doc1_title: "Organization Statute",
    doc2_title: "Report for 2026",
    doc2_desc: "PDF · Annual",
    doc3_title: "Meeting minutes",
    doc4_title: "History of the Council",
    doc4_desc: "PDF · Archive",
    
    contacts_label: "Get in touch",
    contacts_title: "Contacts",
    contacts_desc: "Have questions or want to join our team? We would be glad to hear from you.",
    contacts_address: "Address",
    contacts_address_text: "61022, Kharkiv, Derzhprom, entrance 9, 4th floor",
    ...
    school_header_title: "Young Leader School",
    school_header_desc: "An intensive training program for scientists focused on developing soft skills, project management, and communications",
    school_intro_title: "What is the Leader School?",
    school_intro_desc: "This is a unique educational space where young researchers learn to transform their ideas into successful projects. We bring together top experts in management, fundraising, and public speaking to provide you with practical tools for a career leap.",
    school_stat1_num: "5",
    school_stat1_label: "Weeks of intensive training",
    school_stat2_num: "12",
    school_stat2_label: "Practicing experts",
    school_stat3_num: "100+",
    school_stat3_label: "Graduates",
    school_curriculum_title: "Course Curriculum",
    school_mod1_tag: "Soft Skills",
    school_mod1_title: "Emotional Intelligence and Leadership",
    school_mod1_desc: "How to build trust within a research team, resolve conflicts, and motivate colleagues to achieve results.",
    school_mod2_tag: "Management",
    school_mod2_title: "Scientific Project Management",
    school_mod2_desc: "Basics of Agile and Scrum in science. Budget planning, resource management, and time management.",
    school_mod3_tag: "Fundraising",
    school_mod3_title: "Grant Writing",
    school_mod3_desc: "How to properly prepare a grant application to secure funding from international and European foundations.",
    school_mod4_tag: "PR & Media",
    school_mod4_title: "Science Communication",
    school_mod4_desc: "Presenting research results to businesses and the media. Basics of storytelling and public speaking.",
    school_cta_title: "Applications are open!",
